              ...
              <?php 
                ...
                while($row = $list->fetch_assoc()){
                  echo '<tr>
                      ...
                      <td>'.$row['soal_nama'].'</td>
                      <td>
                        <a title="Edit Data" href="bank_soal_form.php?act=edit&id='.$row['soal_id'].'" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                        <a onclick="return confirm(\'Apakah anda yakin menghapus data ini?\')" title="Hapus Data" href="bank_soal_action.php?act=hapus&id='.$row['soal_id'].'" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                      </td>
